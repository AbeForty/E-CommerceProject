...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
          <div class="head-bread">
            <div class="container">
                <ol class="breadcrumb">
                    ...
                    <li><asp:Label ID="lblBC1" runat="server"></asp:Label></li>
        ...
        <div class="showcase-grid">
            <div class="container">
                ...
                <div class="col-md-4 showcase" style="left: 0px; top: 0px">
                    <div class="showcase-rt-top">
                        ...
                        <h3><asp:Label ID="lblProductName" runat="server" Text=""></asp:Label></h3>
                            ...
                            <p>
                                ...
                                <asp:Label ID="lblGameRating" runat="server" Text="Game Rating"></asp:Label></p>
                            <br />
                            <h4>&#36;<asp:Label ID="lblPrice" runat="server" Text=""></asp:Label></h4>
                        </div>                   
                    </div>
                    <div class="rating-stars" style="margin-top: 160px;">
                        <ul>
                    ...
                    <div class="shocase-rt-bot">
                        ...
                        <ul>
                            <li class="qty" id ="listItemPlatform">
                                <h4>Platform</h4>
                                <asp:DropDownList ID="ddlPlatform" runat="server" AutoPostBack="True" DataSourceID="DSPlatform" DataTextField="Name" DataValueField="ProductID" Width="112px" Height="25px"></asp:DropDownList>                         
                            </li>
                           <li class="qty" id ="listItemQuantity">
                                <h4>QTY</h4>
